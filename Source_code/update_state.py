...
def update_all_saved_parameters(AnT, Sub, L, U, GP, lowlevel):
	...
	AnT.Point_start_eval = array_parameters[7] # 8
	AnT.Point_stop_eval = array_parameters[8] # 9
	AnT.Center_start_eval = array_parameters[9] # 10
	AnT.Center_stop_eval = array_parameters[10] # 11
